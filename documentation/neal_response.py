...
Generates RESPONSE_TO_NEAL.md in the neal_response output folder and
produces supporting figures (kappa convergence chart).

The markdown content is defined in the CONTENT constant below.
This file is the canonical source for the response document.
...
def main():
    ...
    # Write markdown
    md_dest = OUT_DIR / "RESPONSE_TO_NEAL.md"
